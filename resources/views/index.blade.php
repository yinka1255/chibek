...
<link rel="stylesheet" type="text/css" href="{{asset('public/revolution/css/layers.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('public/revolution/css/navigation.css')}}"> 
<style>
    .parallax{
        background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('{{url("images/banners/5.jpg")}}') fixed center center;
        height: 300px;
...
<!-- Document Title
    ============================================= -->
<title>Chibek instruments limited | Solution for science</title>
</head>
<body>
<div class="preloader">
	...
	<nav id="primary-menu" class="navbar navbar-expand-lg navbar-light navbar-bordered">
		<div class="container">
			<a class="navbar-brand" href="index-2.html">
				<img class="logo logo-light" style="width: 130px;" src="{{asset('public/images/logo/logo-light.png')}}" alt="Consultivo Logo">
				<img class="logo logo-dark" style="width: 130px;" src="{{asset('public/images/logo/logo-light.png')}}" alt="Consultivo Logo">
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarContent">
				<ul class="navbar-nav ml-auto">
                    ...
                    <li class="has-dropdown active">
                        <a href="{{url('/')}}" class="dropdown-toggle menu-item">Home</a>
                    </li>
                    <!-- li end -->

                    <!-- Pages Menu -->
                    <li class="has-dropdown">
                        <a href="{{url('about')}}" class="dropdown-toggle menu-item">About</a>
                    </li>
                    <!-- li end -->
                    <!-- Services Menu-->
                    <li class="has-dropdown">
                        <a href="{{url('services')}}" class="dropdown-toggle menu-item">Services</a>
                    </li>
                    <!-- li end -->
                    ...
                    <!-- Blog Menu-->
                    <li class="has-dropdown">
                        <a href="{{url('blog')}}"  class="dropdown-toggle menu-item">Blog</a>
                    </li>
                    <!-- li end -->

                    <!-- shop Menu -->
                    <li class="has-dropdown">
                        <a href="{{url('contact')}}" class="dropdown-toggle menu-item" data-hover="shop">Contact</a>
                    </li>
                    <!-- li end -->
                </ul>
...
<div class="module module-consultation pull-left">
	<a class="btn" href="#">Market Place</a>
</div>				<!-- Module Search -->
	...
	<div class="module-content module-box cart-box">
		<div class="cart-overview">
			<ul class="list-unstyled">
				<li>
					<img class="img-fluid" src="{{asset('public/images/shop/thumb/1.png')}}" alt="product"/>
				...
				<li>
					<img class="img-fluid" src="{{asset('public/images/shop/thumb/2.png')}}" alt="product"/>
					<div class="product-meta">
		...
		<div id="slider1" class="rev_slider"  data-version="5.0">
			<ul>
				...
				<li data-transition="zoomout" 
					...
					<!-- MAIN IMAGE -->
					<img src="{{asset('public/images/sliders/slide-bg/9.png')}}" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
					<div class="tp-caption" 
						...
						data-responsive_offset="on">
 						<div class="slide--subheadline">Free delivery and advice</div>
 					</div>
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
 						<div class="slide--bio">We deliver to your door step</div>
 					</div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="feature-card">
                            ...
                            <div class="feature-card-content">
                                <h3 class="feature-card-title">Pickup/Delivery</h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="feature-card">
                            ...
                            <div class="feature-card-content">
                                <h3 class="feature-card-title">Swift Response</h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="feature-card">
                            ...
                            <div class="feature-card-content">
                                <h3 class="feature-card-title">After Sales Support</h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="feature-card">
                            ...
                            <div class="feature-card-content">
                                <h3 class="feature-card-title">Guaranteed Quality</h3>
    ...
    <div class="container">
        <div class="clients clients-1 pt-30 pb-0 row">
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-2 client">
                <img src="{{asset('public/images/clients/1.png')}}" alt="client">
            </div>
            <!-- .client end -->
            <!-- Client #2 -->
            <div class="col-6 col-sm-6 col-md-4 col-lg-2 client">
                <img src="{{asset('public/images/clients/2.png')}}" alt="client">
            </div>
            <!-- .client end -->
            <!-- Client #3 -->
            <div class="col-6 col-sm-6 col-md-4 col-lg-2 client">
                <img src="{{asset('public/images/clients/3.png')}}" alt="client">
            </div>
            <!-- .client end -->
            <!-- Client #4 -->
            <div class="col-6 col-sm-6 col-md-4 col-lg-2 client">
                <img src="{{asset('public/images/clients/4.png')}}" alt="client">
            </div>
            <!-- .client end -->
            <!-- Client #5 -->
            <div class="col-6 col-sm-6 col-md-4 col-lg-2 client">
                <img src="{{asset('public/images/clients/5.png')}}" alt="client">
            </div>
            <!-- .client end -->
            <!-- Client #6 -->
            <div class="col-6 col-sm-6 col-md-4 col-lg-2 client">
                <img src="{{asset('public/images/clients/6.png')}}" alt="client">
            </div>
            <!-- .client end -->
        </div>
        <!-- .row-clients end -->
...
<section id="video2" class="video-2 bg-overlay bg-overlay-dark2 text-center pb-0">
    <div class="bg-section"><img src="{{asset('public/images/background/3.jpg')}}" alt=""></div>
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-10 offset-lg-1">
                <div class="heading">
                    <p class="heading--subtitle">Quality and Efficiant Products</p>
                    <h2 class="heading--title color-white mb-0">Chibek Gets ISO 9001:2008 Certification</h2>
                </div>
            </div>
            <!-- .col-lg-10 end -->
        </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="video--content text-center">
                    <div class="bg-section">
                        <img src="{{asset('public/images/video/1.gif')}}" alt="Background" />
                    </div>
...
<section id="pricing1" class="pricing pricing-1 bg-overlay bg-overlay-dark2 pt-110 pb-0">
    <div class="bg-section">
        <img src="{{asset('public/images/background/2.jpg')}}" alt="background">
    </div>
    <div class="container">
        <div class="row clearfix">
            <div class="col-sm-12 col-md-12 col-lg-6 offset-md-3">
                <div class="heading heading-1 text--center mb-40">
                    ...
                    <h2 class="heading--title text-white">Some Of Our Products</h2>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 price-table">
                <div class="pricing-panel">
                    ...
                    <div class="pricing--heading text--center">
                        ...
                        <h4>COMP HC 20</h4>
                        <p><span class="currency">₦</span>125k</p>
                        <div class="pricing--desc">
                            Single Phased Lithium Battery Energy
                            Uninterrupted Power Supply 
                            Max 8 Battery Modules Of Each 2, 4KWh
                            AC/PV Charge Power 5000KW/5400KW
                        </div>
                        <a class="btn btn--secondary btn--bordered btn--rounded" href="#">Read More</a>
                    </div>
                    <!--  Pricing heading  -->
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 price-table pricing-active">
                <div class="pricing-panel">
                    ...
                    <div class="pricing--heading text--center">
                        ...
                        <h4>COMP HC 6500</h4>
                        <p><span class="currency">₦</span>165k</p>
                        <div class="pricing--desc">
                            Single Phased Lithium Battery Energy Storage System
                            Uninterrupted Power Supply (UPS)
                            AC/PV Charge Power 2,4KW/3.0KW
                        </div>
                        <a class="btn btn--white btn--bordered btn--rounded" href="#">Read More</a>
                    </div>
                    <!--  Pricing heading  -->
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 price-table">
                <div class="pricing-panel">
                    ...
                    <div class="pricing--heading text--center">
                        ...
                        <h4>COMP HC 3200</h4>
                        <p><span class="currency">₦</span>195k</p>
                        <div class="pricing--desc">
                            Single Phased Lithium Battery Energy Storage System
                            Uninterrupted Power Supply (UPS)
                            AC Charge Power 600W/600W
                        </div>
                        <a class="btn btn--secondary btn--bordered btn--rounded" href="#">Read More</a>
                    </div>
                    <!--  Pricing heading  -->
...
<!-- Team #1
============================================= -->
<section id="team1" class="team team-1 pt-110 pb-60 parallax">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h3 class="subscribe-title">Exceptional After-Sale Support</h3>
                <p class="subscribe-text">We see our customers as invited guests to a party, and we are the hosts. It’s our job every day to make every important aspect of the customer experience a little bit better</p>
            </div>
            <div class="col-md-4 subscribe-btn-container">
                <a class="subscribe-btn" href="{{url('contact')}}">Contact Us Now</a>
            </div>
        </div>
        <!-- .row end -->
    </div>
    ...
    <div class="container-fluid pr-0 pl-0">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6 col-content">
                <div class="heading">
                    <h2 class="heading--title color-white">We Are Here To Ease<br>The Procuremnt Obstacles!</h2>
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 pr-0">
                <div class="banner--img">
                    <img src="{{asset('public/images/banners/1.jpg')}}" alt="banner img">
                </div>
            </div>
            <!-- .col-lg-6 end -->
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="blog-entry">
                    <div class="entry--img">
                        <a href="#">
                            <img src="{{asset('public/images/blog/grid/1.jpg')}}" alt="entry image"/>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="blog-entry">
                    <div class="entry--img">
                        <a href="#">
                            <img src="{{asset('public/images/blog/grid/2.jpg')}}" alt="entry image"/>
                            <div class="entry--overlay"></div>
                        </a>
                    </div>
                    <!-- .entry-img end -->
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="blog-entry">
                    <div class="entry--img">
                        <a href="#">
                            <img src="{{asset('public/images/blog/grid/3.jpg')}}" alt="entry image"/>
                            <div class="entry--overlay"></div>
                        </a>
                    </div>
                    <!-- .entry-img end -->
			...
			<div class="row clearfix">
				<div class="col-12 col-md-6 col-lg-3 footer--widget widget-about">
					<div class="widget-content">
						<img class="footer-logo" style="width: 100px;" src="{{asset('public/images/logo/logo-light.png')}}" alt="logo">
						<p>Chibek Instruments Ltd. Is a modern enterprise specializing in laboratory plan, design, production, installation and after sales services. </p>
	...
	<div class="footer--bar">
 			<div class="row">
                <div class="col-12 col-md-12 col-md-12 text--center footer--copyright">
					<div class="copyright">
						<span>© 2019, </span> <a href="http://themeforest.net/user/7oroof/portfolio?ref=zytheme">Chibek</a>
					</div>
                </div>
 			</div>
		 <!-- .row end -->
...
<!-- RS5.0 Core JS Files -->
<script src="{{asset('public/revolution/js/jquery.themepunch.tools.min.js?rev=5.0')}}"></script>
<script src="{{asset('public/revolution/js/jquery.themepunch.revolution.min.js?rev=5.0')}}"></script>
...
<script src="{{asset('public/js/rsconfig.js')}}"></script>
</body>
</html>
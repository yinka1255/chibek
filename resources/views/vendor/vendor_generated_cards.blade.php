                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('vendor/cards')}}">Requests</a></li>
                                <li class="breadcrumb-item"><a href="{{url('vendor/card_details')}}">Request Card Details</a></li>
                                <li class="breadcrumb-item active">Generated Cards </li>
                            </ol>
                        </div>
                    </div>
                </div>

...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Cares365 | About us</title>
        <meta name="description" content="Healme.net About us">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="about-content">
                            <h2>WELCOME TO <span>HEALME</span></h2>
                            <p>Cares365 is a health foundation comitted to save lives. We bear a burning desire to help eliminate pains in the world. No one can do this alone, and to acheive this we creates an online platform where together, with less effort, great things can be acheived.</p>
                            <p class="hidden-sm">Cares365 is a platform that provides the world the opportunity to make an impact in people's live no matter how little. </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="about-img">

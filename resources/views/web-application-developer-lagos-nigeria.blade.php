...
<head>
    ...
    <title>Nigeria's No1 web dev company: Web application developer in lagos</title>
...
<!--[jumotron]-->
<section id="start">
    <div class="jumbotron2 jumbo img-responsive">
        <div class="container" >
            <div class="title">
                <h1 class="hone">WEB APPLICATION DEVELOPERS</h1>
            </div>
            <p style="color: #fff;">
            ...
            <div class="col-md-6 about-text about-img">
                <div class="gradient" style="text-align: justify !important;">
                    <div {{--data-sr='wait 0.1s, then enter left and hustle 125px over 1.5s'--}}>
                        <h2 style="margin-top: 0 !important;text-align: center;">Web app development</h2>
                        <div class="testimonial-border-white"></div>
                        <p id="text-aboutus">Lets help you bring your idea to live. We possess extensive knowledge and experience in web application development, deployment, security, load balancing, payment integration, ECommerce, SEO friendly architecture, and devOps. We ensure you get a world class application at a lower cost. Here's some of our stack                            </p>
                        <div class="row">
                            <div class="col-md-3">
                                <ul>
                                    <li>Java</li>

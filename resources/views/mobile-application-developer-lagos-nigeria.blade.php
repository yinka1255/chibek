...
<head>
    ...
    <title>Best Mobile app developer: Mobile app developer Lagos, Nigeria</title>
    <meta name="description" content="Nigeria's No.1 Mobile application developer - We provide unbelievably cheap and breath taking designs, world class web and mobile application development in Lagos, Nigeria. We are also expert in social media marketing marketing">
    <meta name="keywords" content="Web designer, Web developer, software developer, web development company, software development company, lagos, nigeria,">
    ...
    <style>
        ...
        .left-img{
            background: url(http://localhost/imperial/public/customers/images/bg6.jpg);
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right nav nav-pills">
                <li class="active"><a class="page-scroll" href="{{url('/#start')}}">HOME</a></li>
                <li><a class="page-scroll" href="{{url('/#about')}}">ABOUT US</a></li>
                <li><a class="page-scroll" href="{{url('/#what_we_do')}}">WHAT WE DO</a></li>
...
<!--[jumotron]-->
<section id="start">
    <div class="jumbotron4 jumbo img-responsive">
        <div class="container" >
            <div class="title">
                <h1 class="hone">MOBILE APPLICATION DEVELOPERS</h1>
            </div>
            <p style="color: #fff;">
                Whatever your idea is, we'd help you bring it to live.
            </p>
    </div>
</div>
</section>
            ...
            <div class="col-md-6 about-text about-img">
                <div class="gradient" style="text-align: justify !important;">
                    <div {{--data-sr='wait 0.1s, then enter left and hustle 125px over 1.5s'--}}>
                        <h2 style="margin-top: 0 !important;text-align: center;">Mobile app development</h2>
                        <div class="testimonial-border-white"></div>
                        <p id="text-aboutus">Lets help you bring your idea to live. We possess extensive knowledge and experience in mobile application development, deployment and devOps. We ensure you get a world class application at a lower cost. Here's some of our stack                            </p>
                        <div class="row">
                            <div class="col-md-4">
                                <ul>
                                    <li>Java</li>
                        ...
                        <div class="button-plans">
                                <a class="btn c-button btn-md pull-right" href="{{url('/#contact')}}" role="button" data-anijs="if: mouseover, do: pulse animated"> Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 left-img"{{--data-sr='wait 0.1s, then enter right and hustle 125px over 1.5s'--}}>
